...
<p>{l s='Your order on %s is complete.' sprintf=$shop_name mod='swipp'}
		<br /><br />
		{l s='Please send us a bank wire with' mod='swipp'}
		...
		<br /><br />- {l s='Include these details' mod='swipp'}  <strong>{if $swippDetails}{$swippDetails}{else}___________{/if}</strong>
		<br /><br />- {l s='Bank name' mod='swipp'}  <strong>{if $swippAddress}{$swippAddress}{else}___________{/if}</strong>
		{if !isset($reference)}
		...
		{/if}		<br /><br />{l s='An email has been sent with this information.' mod='swipp'}
